...
class Simulator(PrimaryResource):
    ...
    Attributes:
        ...
        image (:obj:`str`): id for image in DockerHub (e.g., "biosimulators/tellurium:2.1.6")
    ...
    def __init__(self, id=None, version=None, url=None,
        ...
        Args:
            ...
            image (:obj:`str`, optional): id for image in DockerHub (e.g., "biosimulators/tellurium:2.1.6")
